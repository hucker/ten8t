...
def check_folder1():
    ...
    yield rule_path_exists("../examples/file_system/folder1")


@attributes(tag="folder", ruid="f2", level=1, phase="proto")
def check_folder2():
    """ Simple always passing function"""
    yield rule_path_exists('../examples/file_system/folder2')
...
def check_files_f2():
    ...
    for f in ['file1.txt', 'file2.txt']:
        yield rule_path_exists(f'../examples/file_system/folder2/{f}')
...
def check_files_f1():
    """ Simple always passing function"""
    for f in ['file1.txt', 'file2.txt']:
        yield rule_path_exists(f'../examples/file_system/folder1/{f}')
