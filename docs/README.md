...
This code will run the checker and save of the data to the file `results.json`
...
def json_rule(cfg):
    yield from t8.rule_ten8t_json_file(file_name='results.json')
...
While this code will take the results file generated by the first code and import it into its own checker.
